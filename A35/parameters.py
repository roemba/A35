...
class parameters:
    ...
    verticaldisplacementhinge1 = (11.03/100.)/2.54 #Vertical_displacement_hinge_1	d_1	11.03	cm
    verticaldisplacementhinge3 = (16.42/100.)/2.54 #Vertical_displacement_hinge_3	d_3	16.42	cm
